package com.sunmi.cordova.utils;
...
import com.sunmi.cordova.bean.TableItem;
...
public class AidlUtil {
    ...
    private static final String toast_2 = "未找到打印机";
    ...
    public void setDarkness(int index) {
        if (woyouService == null) {
            Toast.makeText(context, toast_2, Toast.LENGTH_LONG).show();
            return;
        }
